...
echo '<html lang="en">';
echo '<head>';
echo '<title>Huerto El Mamey</title>';
...
echo '<model-viewer bounds="tight" src="Bolsa.glb" ar ar-modes="webxr scene-viewer quick-look" camera-controls environment-image="neutral" poster="poster.webp" shadow-intensity="2" shadow-softness="1" exposure="0.49">';
